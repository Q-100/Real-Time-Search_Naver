...
urls = ["https://news.naver.com/main/list.nhn?mode=LSD&mid=sec&sid1=001&listType=title&date=20210418",  # 네이버 속보
        "https://news.naver.com/main/list.nhn?mode=LPOD&sid2=140&sid1=001&mid=sec&oid=001&isYeonhapFlash=Y&date=20210418",
        # 연합뉴스 속보
...
banned = ['',
          ...
          'Belgium',
          'WOMEN',"GERMANY", "REGIONAL","ELECTIONS","BRITAIN","PANDEMIC",'CORONAVIRUS','COVID19'
          ]
